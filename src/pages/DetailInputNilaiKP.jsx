    ...
    <>
      ...
      <div className="p-4">
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 auto-rows-[minmax(180px,_auto)] gap-5">
          <div className="col-span-1 p-6 bg-white border rounded-md shadow-md lg:row-span-2 border-gray shadow-black/7">
          ...
          {seminarData &&
            ...
            seminarData.pembimbing.map((dospem, index) => (
              <div
                key={index}
                className="col-span-1 p-6 bg-white border rounded-md shadow-md lg:row-span-1 border-gray shadow-black/7"
              >
                <CardDospem
                  dataDosen={dospem}
                  ket="Pembimbing"
          ...
          <div className="relative col-span-1 p-6 bg-white border rounded-md shadow-md lg:row-span-2 border-gray shadow-black/7">
            <CardNilai
              dataSeminar={seminarData}
              userInfo={userInfo}
              ket={ket}
          ...
          <div className="col-span-1 p-6 bg-white border rounded-md shadow-md sm:col-span-2 lg:col-span-2 lg:row-span-2 border-gray shadow-black/7">
